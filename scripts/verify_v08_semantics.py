...
# Native frontend integration (no dynamic bridge or compatibility API wrapper).
index = (ROOT / "frontend/index.html").read_text(encoding="utf-8")
app_js = (ROOT / "frontend/app.js").read_text(encoding="utf-8")
textbook_html = (ROOT / "frontend/textbook.html").read_text(encoding="utf-8")
textbook_js = (ROOT / "frontend/textbook.js").read_text(encoding="utf-8")
...
if errors:
    print('V0.8 SEMANTIC GATE: FAIL')
    for e in errors: print('- '+e)
    raise SystemExit(1)
print('V0.8 SEMANTIC GATE: PASS')
